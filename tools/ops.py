import tools.patch  # Reçoit le patch qui intercepte tensorflow.contrib !
...
weight_init = tf.random_normal_initializer(mean=0.0, stddev=0.02) # weight_init = tf_contrib.layers.xavier_initializer()
weight_regularizer = slim.l2_regularizer(scale=0.0001)
